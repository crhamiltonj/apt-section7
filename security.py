...
def authenticate(username: str, password: str):
    """
    Function that gets called when a user called the auth endpoint
    with their username and password
    :param username: User's username un string format.
...
def identity(payload):
    ...
    :param payload: A distionary with 'identity' key, which is the user id.
